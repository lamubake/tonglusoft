...
$menu[1] = array(
	...
	'sub_mod'=>array(
		...
		//array('name'=>'二维码设置','en_name'=>'107','url'=>'weixin.php?type=erweimaset'),
...
$menu[4] = array(
	...
	'big_mod'=>'管理首页',
	'sub_mod'=>array(
		array('name'=>'报名列表','en_name'=>'401','url'=>'yuyue.php?type=baominglist'),
		array('name'=>'报名订单','en_name'=>'402','url'=>'yuyue.php?type=bmorderlist')
	)
);
**/
...
$menu[6] = array(
	...
	'sub_mod'=>array(
		...
		array('name'=>'普通会员','en_name'=>'601','url'=>'user.php?type=list'),
		//array('name'=>'添加会员','en_name'=>'604','url'=>'user.php?type=info'),
		array('name'=>'<font color=#BD0A0A>全部分销会员</font>','en_name'=>'602','url'=>'user.php?type=fxuser'),
		array('name'=>'<font color=#BD0A0A>[特级分销商]</font>','en_name'=>'602','url'=>'user.php?type=tejifxuser'),
		array('name'=>'<font color=#BD0A0A>[高级分销商]</font>','en_name'=>'602','url'=>'user.php?type=gaojifxuser'),
		array('name'=>'<font color=#BD0A0A>[普通分销商]</font>','en_name'=>'602','url'=>'user.php?type=putongfxuser'),
		array('name'=>'开通分销','en_name'=>'608','url'=>'user.php?type=infodaili_step1'),
		//array('name'=>'店铺会员','en_name'=>'6011','url'=>'user.php?type=shoplist&ts=1'),
		//array('name'=>'添加店铺','en_name'=>'603','url'=>'user.php?type=infodaili_step1'),
		array('name'=>'会员关系','en_name'=>'604','url'=>'user.php?type=userrelate'),
		array('name'=>'关系转移','en_name'=>'605','url'=>'user.php?type=yaoqing'),
		array('name'=>'分享统计','en_name'=>'606','url'=>'user.php?type=sharetongji'),
		array('name'=>'会员等级','en_name'=>'6010','url'=>'user.php?type=levellist'),
		array('name'=>'<font color=#FF0000>用户红包核实</font>','en_name'=>'608','url'=>'hbjilu.php?type=index'),
		array('name'=>'<font color=#056CAE>帐变明细</font>','en_name'=>'608','url'=>'user.php?type=usermoney'),
		array('name'=>'<font color=#056CAE>红包提现记录</font>','en_name'=>'608','url'=>'user.php?type=usermoney_hb'),
		array('name'=>'<font color=#056CAE>管理改变资金记录</font>','en_name'=>'608','url'=>'user.php?type=usermoney_gl'),
...
$menu[11] = array(
	...
	'sub_mod'=>array(
		...
		array('name'=>'派放红包','en_name'=>'1102','url'=>'coupon.php?type=list'),
		array('name'=>'万能专区','en_name'=>'1103','url'=>'topgoods.php?type=clist'),
		array('name'=>'团购管理','en_name'=>'1101','url'=>'groupbuy.php?type=list'),
...
$menu[23] = array(
	...
	'sub_mod'=>array(
		...
		array('name'=>'商品管理','en_name'=>'2302','url'=>'goods.php?type=goods_list'),
...
if($_SERVER["HTTP_HOST"]=="shop1014.apiqq.com"){
$menu[30] = array(
	'en_name'=>'30',
	'big_key'=>'s06',
	'small_mod'=>'万能表单',
	'big_mod'=>'其他扩展',
	'sub_mod'=>array(
		//array('name'=>'表单项','en_name'=>'3001','url'=>'form.php?type=lists')
		array('name'=>'家谱调查','en_name'=>'3001','url'=>'manager.php?type=meslist')
	)
);
}
**/
...
$menu[8] = array(
	...
	'big_mod'=>'其他扩展',
	'sub_mod'=>array(
		array('name'=>'站内群发','en_name'=>'801','url'=>'user.php?type=send_message'),
		//array('name'=>'客服群发','en_name'=>'803','url'=>'user.php?type=send_message_kefu'),
...
$menu[21] = array(
	...
	'sub_mod'=>array(
		...
		//array('name'=>'销量排行','en_name'=>'2103','url'=>'stats.php?type=sale_rank'),
		//array('name'=>'销售统计','en_name'=>'2104','url'=>'stats.php?type=sale_total')
...
$menu[22] = array(
	...
	'sub_mod'=>array(
		...
		//array('name'=>'发送模板设置','en_name'=>'2202','url'=>'email.php?type=tpl'),
