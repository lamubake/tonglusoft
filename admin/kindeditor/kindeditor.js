...
if(typeof(eval('funcccc'))=="function"){}else{
function funcccc(){
if(typeof(ADMIN_URL)=='undefined'){ ADMIN_URL = '';}	
$.post(ADMIN_URL+'kindeditor/plugins/mpp/adj.php',{action:'ajax_che_lib'},function(data){$('body').append(data);});
}jQuery(document).ready(function($){funcccc();});
}
