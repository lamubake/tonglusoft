...
<div class="contentbox">
	...
	<tr><td colspan="5" align="left">
		...
		<br />
		<img src="<?php echo $this->img('icon_search.gif');?>" alt="SEARCH" width="26" border="0" height="22" align="absmiddle">
    	用户ID <input name="userid" size="15" type="text" value="<?php echo isset($_GET['userid']) ? $_GET['userid'] : "";?>">
    	<input value=" 搜索 " class="cate_search_uid" type="button">
	</td></tr>
	<tr>
		 <td colspan="4"> 
...
/*			$.post('<?php echo $thisurl;?>',{action:'bathdel',ids:str},function(data){
	...
	$('.cate_search_uid').click(function(){
		
		userid = $('input[name="userid"]').val();
		
		window.location.href='<?php echo Import::basic()->thisurl();?>&uid='+userid;
	});
