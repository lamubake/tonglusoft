 ...
 <div class="menu_content">
	 ...
	 <tr>
	  ...
	  <tr>
			...
			<b>销售：</b><input name="sale_count" value="<?php echo isset($rt['sale_count']) ? $rt['sale_count'] : '0';?>" size="20" type="text" />
			</td>
        </tr>
	...
	<tr>
	 ...
	 <select name="uid">
		...
		?>
        <option value="<?php echo $row['user_id'];?>" <?php if(isset($rt['uid'])&&$rt['uid']==$row['user_id']){ echo 'selected="selected""'; } ?>><?php echo $row['nickname'];?></option>
		<?php
		 }//end foreach
		} ?>
        </select>
	  ...
	  <td align="left" style="color:#FF0000">
	  	<ul class="ajaxshowmoney">
			<li style="width:180px; float:left; position:relative; padding-bottom:5px;">
				<!--<b>普通分销佣金:</b>--><input name="takemoney1" id="takemoney1"  type="text" size="8" value="<?php echo isset($rt['takemoney1']) ? $rt['takemoney1'] : '0.00';?>">元
				<!--<div style="height:70px; width:110px; position:absolute; top:25px; left:42px; z-index:99; background:#ededed; border:1px solid #e4e4e4; display:none">
				 ...
				 一层分佣&nbsp;&nbsp;<b><?php echo isset($rd['ticheng180_1']) ? $rd['ticheng180_1'] : '0';?></b>&nbsp;&nbsp;%<br/>
				 二层分佣&nbsp;&nbsp;<b><?php echo isset($rd['ticheng180_2']) ? $rd['ticheng180_2'] : '0';?></b>&nbsp;&nbsp;%<br/>
				 三层分佣&nbsp;&nbsp;<b><?php echo isset($rd['ticheng180_3']) ? $rd['ticheng180_3'] : '0';?></b>&nbsp;&nbsp;%<br/>
				  </p>
				</div>-->
			</li>
			<!--<li style="width:180px; float:left; position:relative; padding-bottom:5px; background:url(<?php echo $this->img('direc.gif');?>) 115px bottom no-repeat">
				<b>高级分销佣金:</b><input name="takemoney2" id="takemoney2"  type="text" size="8" value="<?php echo isset($rt['takemoney2']) ? $rt['takemoney2'] : '0.00';?>">元
				<div style="height:70px; width:110px; position:absolute; top:25px; left:42px; z-index:99; background:#ededed; border:1px solid #e4e4e4; display:none">
				  <p style="line-height:21px; padding:5px; margin:0px;">
				 一层分佣&nbsp;&nbsp;<b><?php echo isset($rd['ticheng180_h1_1']) ? $rd['ticheng180_h1_1'] : '0';?></b>&nbsp;&nbsp;%<br/>
				 二层分佣&nbsp;&nbsp;<b><?php echo isset($rd['ticheng180_h1_2']) ? $rd['ticheng180_h1_2'] : '0';?></b>&nbsp;&nbsp;%<br/>
				 三层分佣&nbsp;&nbsp;<b><?php echo isset($rd['ticheng180_h1_3']) ? $rd['ticheng180_h1_3'] : '0';?></b>&nbsp;&nbsp;%<br/>
				  </p>
				</div>
			</li>
			<li style="width:180px; float:left; position:relative; padding-bottom:5px; background:url(<?php echo $this->img('direc.gif');?>) 115px bottom no-repeat">
				<b>特权分销佣金:</b><input name="takemoney3" id="takemoney3"  type="text" size="8" value="<?php echo isset($rt['takemoney3']) ? $rt['takemoney3'] : '0.00';?>">元
				<div style="height:130px; width:110px; position:absolute; top:25px; left:42px; z-index:99; background:#ededed; border:1px solid #e4e4e4; display:none">
				  <p style="line-height:18px; padding:5px; margin:0px;">
				   当销售额达<b><?php echo isset($rd['minsalenum']) ? $rd['minsalenum'] : '0.00';?></b>元，再享线下所有会员的业绩<b><?php echo isset($rd['ticheng180_all']) ? $rd['ticheng180_all'] : '0';?></b>%<br/>
				 一层分佣&nbsp;&nbsp;<b><?php echo isset($rd['ticheng180_h2_1']) ? $rd['ticheng180_h2_1'] : '0';?></b>&nbsp;&nbsp;%<br/>
				 二层分佣&nbsp;&nbsp;<b><?php echo isset($rd['ticheng180_h2_2']) ? $rd['ticheng180_h2_2'] : '0';?></b>&nbsp;&nbsp;%<br/>
				 三层分佣&nbsp;&nbsp;<b><?php echo isset($rd['ticheng180_h2_3']) ? $rd['ticheng180_h2_3'] : '0';?></b>&nbsp;&nbsp;%<br/>
				  </p>
				</div>
			</li>-->
