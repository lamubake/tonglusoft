	...
	<tr>
	 ...
	 <select name="uid">
	  ...
	  <td align="left" style="color:#FF0000">
	  	<b>普通分销佣金:</b><input name="takemoney1" id="takemoney1"  type="text" size="13" value="<?php echo isset($rt['takemoney1']) ? $rt['takemoney1'] : '0.00';?>">
		<b>高级分销佣金:</b><input name="takemoney2" id="takemoney2"  type="text" size="13" value="<?php echo isset($rt['takemoney2']) ? $rt['takemoney2'] : '0.00';?>">
		<b>特权分销佣金:</b><input name="takemoney3" id="takemoney3"  type="text" size="13" value="<?php echo isset($rt['takemoney3']) ? $rt['takemoney3'] : '0.00';?>">
		&nbsp;&nbsp;&nbsp;<span style="color:#222">再按三层返佣比例</span><a style=" text-decoration:underline; color:#FE0000" href="<?php echo ADMIN_URL.'weixin.php?type=userconfig';?>" target="_blank">[点击查看]</a>
	  </td>
	  </tr>
	  ...
	  <td align="left">
	  	<input name="youfei" id="youfei"  type="text" size="13" value="<?php echo isset($rt['youfei']) ? $rt['youfei'] : '0.00';?>">
	  </td>
	  </tr>
	  ...
	  <td align="left">
	  	<input name="end_time" id="end_time"  type="text" size="20" value="<?php echo isset($rt['end_time']) ?  date('Y-m-d H:i:s',$rt['end_time']) : ' ';?>"> * (时间格式：2015-10-19 12:00:00)
	  </td>
	  </tr>
	  -->
	   <tr>
