...
<div style="min-height:300px; padding-bottom:10px; font-size:14px; background:#FFF" class="ucenter">
  	...
  	<div data-role="content" class="ui-content" role="main" style="padding-top:8px; overflow:inherit">
		...
		<div class="uitem">
			<p class="pp">
				<a href="javascript:;" onclick="ajax_show_sub(1,this);"><i></i>我的分销商<span><?php echo empty($rt['zcount']) ? '0' : $rt['zcount'];?>人</span></a>
			</p>
			
			<ul class="gonglist gg1">
				<li class="uli6"><p><a href="<?php echo ADMIN_URL.'daili.php?act=myuser&t=1';?>"><i></i>一级伙伴<span><?php echo empty($rt['zcount1']) ? '0' : $rt['zcount1'];?>人</span></a></p></li>
				<li class="uli9"><p><a href="<?php echo ADMIN_URL.'daili.php?act=myuser&t=2';?>"><i></i>二级伙伴<span><?php echo empty($rt['zcount2']) ? '0' : $rt['zcount2'];?>人</span></a></p></li>
				<li class="uli10"><p><a href="<?php echo ADMIN_URL.'daili.php?act=myuser&t=3';?>"><i></i>三级伙伴<span><?php echo empty($rt['zcount3']) ? '0' : $rt['zcount3'];?>人</span></a></p></li>		
				<div class="clear"></div>
			</ul>
		...
		<div class="uitem">
			<p class="pp">
				<a href="javascript:;" onclick="ajax_show_sub(3,this);"><i></i>我的佣金<span>￥<?php echo $rt['pay1']+$rt['pay2']+$rt['pay3']+$rt['pay4']+$rt['pay5'];?></span></a>
			</p>
