...
<div id="main" style="padding:5px; padding-top:0px; min-height:300px">
	...
	<div class="goodslist">
		...
		<tr>
			...
			<p style="padding-top:5px; padding-left:10px; font-size:14px;">支付方式：<b><?php echo $orderinfo['pay_name'];?></b>
			<?php
				if($orderinfo['order_amount']=='0.00')
					echo"（0元产品请选择余额支付！）";
			?>
			</p>
		...
		<?php if($orderinfo['pay_status'] !='1'){?>
		<div>
			<a href="<?php echo ADMIN_URL.'mycart.php?type=fastpay2&oid='.$orderinfo['order_id'];?>" class="btn-buy button ui-btn ui-btn-text-only"><span class="ui-btn-text">立即支付</span></a>
