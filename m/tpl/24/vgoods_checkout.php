...
<div id="main" style="padding-top:0px; min-height:300px">
	...
	<form action="<?php echo ADMIN_URL;?>vgoods.php?type=confirm" method="post" name="CONSIGNEE_ADDRESS" id="CONSIGNEE_ADDRESS">
		   ...
		   ?>
			...
			<tr>
				...
				<?php if(!empty($row['spec'])){
				 ...
				 <p style=" padding-left:10px;font-size:12px;line-height:20px;" class="raturnprice raturnprice<?php echo $k;?>"><!--专柜价:<font color="#5f5f5f">￥<?php echo $row['shop_price'];?></font>&nbsp;&nbsp;-->原价:<font color="#FF0000" class="gprice">￥<?php echo $row['pifa_price']>0 ? $row['pifa_price']  : $row['shop_price'];?></font></p>
				 <div class="item" style="height:20px; line-height:20px; position:relative; padding-left:10px; padding-top:7px">
						...
						&nbsp;&nbsp;优惠价:<font color="#FF0000">￥<span class="gzprice"><?php echo $row['pifa_price']; ?></span></font>
				  </div>
				</td>
			</tr>
		...
		<div style="padding-left:5px;">
			<p style="font-size:16px; font-weight:bold; color:#DB383E; padding-top:5px;">结算总金额：<br/>￥<span class="ztotals"><?php echo $total; ?></span>元</p>
